...
(function() {
	...
	module.exports = (L.Layer || L.Class).extend({
		...
		options: {
			...
			draggableWaypoints: false,//cus
			routeWhileDragging: false,
			addWaypoints: false,//cus
			...
			/*createMarker: function(i, wp) {
				var options = {
						//draggable: this.draggableWaypoints//cus
					};
				    //marker = L.marker(wp.latLng, options);//cus
