              ...
              <table border="1" style="width:100%">
                  <tbody>
                    <tr>
                      ...
                      <th style="text-align:center"><span style="color:#ffffff; font-family:tahoma,geneva,sans-serif"><span style="font-size:14px">Image</span></span></th>
                    ...
                    <tr>
                      ...
                      <td style="text-align:center"><span style="font-size:14px"><span style="font-family:tahoma,geneva,sans-serif">{{$vehicle->image}}</span></span></td>
                      <td style="text-align:center"><span style="font-size:14px"><span style="font-family:tahoma,geneva,sans-serif"><a href="#">Detail</a><br><a href="#">Book Now</a>
                      </span></span></td>
                    </tr>
                    @endforeach
